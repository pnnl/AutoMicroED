...
#Load the raw file
path = "165749merged_0009_tail_2.img"

#f = open(filename,'rb') # switch to command line args later

'''
with io.open(path,'rb',encoding='latin-1') as f_in:
	#ValueError: binary mode doesn't take an encoding argument
    latin_1_text = f_in.read()
    print (f"latin_1_text:{latin_1_text}")
    a=b
'''

'''
with io.open(path,'r',encoding='latin-1') as f_in:
    latin_1_text = f_in.read()
    print (f"latin_1_text:{latin_1_text}")
    #oyyk|oyu...
    a=b
'''
#with io.open(path,'r',encoding='utf8') as f_in:
    #utf8_text = f_in.read()
    #UnicodeDecodeError: 'utf-8' codec can't decode byte 0xda in position 1: invalid continuation byte

    #print (f"utf8_text:{utf8_text}")
    #a=b
